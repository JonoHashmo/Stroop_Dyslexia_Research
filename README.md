...
A reverse stroop task consists of the exact reverse. Meaning, the participant must identify the word being presented regardless of the color of the ink it is written in (i.e. if the word RED is printed in blue color, the correct answer would be RED). 
